...
import com.example.friendlyneighborhood.Adapter.EventPdfAdapter;
...
import com.example.friendlyneighborhood.databinding.FragmentEventPdfBinding;
...
public class EventPdfFragment extends Fragment {

    FragmentEventPdfBinding binding;
    ArrayList<ReservationModel> list;
    ArrayList<ReservationModel> Oldlist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEventPdfBinding.inflate(inflater,container,false);
        fromDate = getArguments().getString("from");
        toDate = getArguments().getString("to");

        recyclerView = binding.EventsTableRv;
        list= new ArrayList<>();
        ...
        EventPdfAdapter adapter = new EventPdfAdapter(getContext(), list);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                                ...
                                try {
                                    if(validDate(reservation.getReservationDate()))
                                    {
        ...
        binding.DownloadEventPdfBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                createPDF(binding.tableLayoutPdfEv);
            }
        });
    ...
    private void createFile()
    {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "events.pdf");
